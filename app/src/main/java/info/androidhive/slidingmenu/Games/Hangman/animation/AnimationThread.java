 ...
 * 
 */
package info.androidhive.slidingmenu.Games.Hangman.animation;
...
public class AnimationThread extends Thread {
	...
	public AnimationThread(SurfaceHolder surfaceHolder, Animation animationPanel) {
		super();
			...
			try {
				...
				synchronized (surfaceHolder) {
					...
					while (sleepTime < 0 && framesSkipped < MAX_FRAME_SKIPS) {
						// we need to catch up
						this.animationPanel.update(); // update without rendering
